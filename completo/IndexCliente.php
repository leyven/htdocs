...
<div id="ClienteNuevo">
	<form action="InsertarRegistros.php" enctype="multipart/form-data" method="post">
		...
		Descripcion: <textarea name="DescripcionCliente"autofocus >Puede expandir este campo si asi lo desea</textarea> <br/>
...
<p>Consulta de pruebas</p>
	<form action="ConsultaPruebas.php" method="post">
		Numero de solicitud: <input type="text" name="NumeroSolicitud"/>  <br/>
