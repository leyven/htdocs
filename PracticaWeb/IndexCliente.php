...
<div id="ClienteNuevo">
	<form action="InsertarRegistros.php" enctype="multipart/form-data" method="post">
		<p>Nuevo cliente</p>
		Nombre: <input type="text" name="NombreCliente"id="NombreCliente"/>	  <br/>
		E-mail :  <input type="text" name="EmailCliente" id="EmailCliente"/>      <br/>
		Telefono: <input type="text" name="TelefonoCliente"id="TelefonoCliente"/> <br/>
